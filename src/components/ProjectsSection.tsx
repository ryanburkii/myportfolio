...
export function ProjectsSection() {
  const projects = [
    {
      title: "Homelab",
      description: "My mini server stack consisting of 2 Proxmox servers, a small Unifi stack, and a custom built NAS. Current services: Plex, NextCloud, game servers, and more.",
    ...
    {
      title: "Workout App",
      description: "A rough mockup of a competitive workout tracker. I plan to implement a leaderboard for sharing statistics with friends.",
      image: "/api/placeholder/400/250",
    ...
    },
    {
      ...
      description: "This website! I plan to expand this website for blogging purposes and to showcase my future projects.",
      image: "/api/placeholder/400/250",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Here are some of my current projects that showcase my skills and passion.
          </p>
        </div>

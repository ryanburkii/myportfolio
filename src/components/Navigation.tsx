      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            >
              <div className="w-12 h-12 relative rounded-full overflow-ellipsis transition-all duration-300 hover:animate-pulse hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.7)]">
                <Image
                  src="/logo-nobg.png"
                  alt="logo"
                  fill
              ...
              <span className="ml-3 overflow-hidden whitespace-nowrap text-white text-lg font-bold transform translate-x-[-30px] opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                rjb.rip
              </span>
            </button>
          </div>

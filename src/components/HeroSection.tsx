      ...
      <div className="text-center max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            I am a dedicated IT professional with a passion for technology and I am always looking to learn new things. Currently,
            my main focus is on cloud infrastructure and cloud security.
          </p>
        </div>
